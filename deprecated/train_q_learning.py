...
def main(grid_paths: list[Path], no_gui: bool, n_eps: int, iters: int, fps: int,
...
if __name__ == '__main__':
    args = parse_args()
    main(args.GRID, args.no_gui, args.iter, args.n_eps, args.fps, args.sigma, args.random_seed)